...
**1 of the 115 operators listed here is still missing** out of 203 total `ai.onnx` operators considered (88 more were already supported before this list was written — see bottom of file). The remaining one operates on `tensor(string)`, which is passed through the converted model as a numpy string array instead of a torch tensor. This excludes the `ai.onnx.ml` (classical ML), `ai.onnx.preview`, and `ai.onnx.preview.training` domains, which are out of scope for a neural-network-focused converter; ping if you want those added too.
...
- [x] [`TensorScatter`](https://onnx.ai/onnx/operators/onnx__TensorScatter.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/tensorscatter.py)
...
- [x] [`QLinearConv`](https://onnx.ai/onnx/operators/onnx__QLinearConv.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/qlinearconv.py)
- [x] [`QLinearMatMul`](https://onnx.ai/onnx/operators/onnx__QLinearMatMul.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/qlinearmatmul.py)
...
- [x] [`RandomUniform`](https://onnx.ai/onnx/operators/onnx__RandomUniform.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node) *(no dedicated generator script at this commit)*

## Signal Processing & Windowing

- [x] [`DFT`](https://onnx.ai/onnx/operators/onnx__DFT.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/dft.py)
- [x] [`STFT`](https://onnx.ai/onnx/operators/onnx__STFT.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/stft.py)
...
- [x] [`HannWindow`](https://onnx.ai/onnx/operators/onnx__HannWindow.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/hannwindow.py)
- [x] [`MelWeightMatrix`](https://onnx.ai/onnx/operators/onnx__MelWeightMatrix.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/melweightmatrix.py)
- [x] [`ImageDecoder`](https://onnx.ai/onnx/operators/onnx__ImageDecoder.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/image_decoder.py)
...
- [x] [`RegexFullMatch`](https://onnx.ai/onnx/operators/onnx__RegexFullMatch.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/regex_full_match.py)
- [x] [`StringConcat`](https://onnx.ai/onnx/operators/onnx__StringConcat.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/string_concat.py)
- [x] [`StringNormalizer`](https://onnx.ai/onnx/operators/onnx__StringNormalizer.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/stringnormalizer.py)
...
- [x] [`NegativeLogLikelihoodLoss`](https://onnx.ai/onnx/operators/onnx__NegativeLogLikelihoodLoss.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/negativeloglikelihoodloss.py)
- [x] [`SoftmaxCrossEntropyLoss`](https://onnx.ai/onnx/operators/onnx__SoftmaxCrossEntropyLoss.html) — [test cases](https://github.com/onnx/onnx/tree/0dd7987d73780e1801691e7465b63288a8bcab2b/onnx/backend/test/case/node/softmaxcrossentropy.py)
